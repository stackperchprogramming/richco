      ...
      <div class="inbox_msg">
        <div class="inbox_people">
          <div class="headind_srch">
            <div class="recent_heading text-muted">
              <h4>Messages</h4>
            </div>
            <div class="srch_bar">
          ...
          <div class="inbox_chat" id="users_container">
            <div class="chat_list active_chat">
              <div class="chat_people">
                <div class="chat_img"> <img src="https://ptetutorials.com/images/user-profile.png" alt="sunil"> </div>
                <div class="chat_ib">
                  <h5>Me Mcmeme <span class="chat_date">Dec 25</span></h5>
                  <p>Test, which is a...</p>
                </div>
              </div>
            </div>
        ...
        <div class="mesgs" id='mesgs'>
          <div class="msg_history">
            ...
            <div class="outgoing_msg">
              <div class="sent_msg">
                <p>McJiggiger text fontish kind of texter text</p>
                <span class="time_date"> 11:01 AM    |    Today</span> </div>
            </div>
            <div class="incoming_msg" id='last_msg'>
              <div class="incoming_msg_img"> <img src="https://ptetutorials.com/images/user-profile.png" alt="sunil"> </div>
              <div class="received_msg ">
                <div class="received_withd_msg">
          ...
          <div class="type_msg">
            <div class="input_msg_write">
              ...
              <button class="msg_send_btn" id='msg_send' type="button"><i class="fa fa-paper-plane" aria-hidden="true"></i></button>
            </div>
          </div>
        </div>
      </div>
